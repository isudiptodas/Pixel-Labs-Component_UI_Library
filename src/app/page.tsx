  ...
  return (
    <>
      <div className={`w-full ${dark ? "bg-black" : "bg-white"} min-h-screen flex flex-col justify-start items-center relative overflow-hidden`}>
        ...
        {/* sidebar */}
        <div className={`fixed ${sidebarVisible ? "translate-x-0" : "translate-x-full"} duration-500 ease-in-out rounded-l-3xl top-0 right-0 h-screen overflow-hidden flex flex-col justify-start items-center z-30 w-full bg-orange-500 shadow-2xl`}>
          ...
          <Link href='/about' className={`w-full mt-10 py-2 text-start px-5 text-white text-xl font-Recline`}>About</Link>
        ...
        {/* navbar */}
        <div className={`w-[95%] z-20 fixed top-5 h-auto backdrop-blur-2xl ${dark ? "bg-black/15" : "bg-white/15"} duration-200 ease-in-out px-5 flex justify-between items-center py-5 lg:py-2 rounded-full border ${dark ? "border-gray-400" : "border-zinc-600"}`}>
          <p className={`${dark ? "text-white" : "text-black"} duration-200 ease-in-out font-semibold text-xl font-Nearo`}>Pixel Labs</p>
          ...
          <div className={`hidden lg:flex justify-center items-center gap-2`}>
            <p className={`w-auto group hover:text-white duration-200 ease-in-out rounded-full px-5 py-2 overflow-hidden ${dark ? "text-white" : "text-black"} duration-200 ease-in-out font-Recline text-lg cursor-pointer relative`}>
              <span className={`relative z-20`}>About</span>
              <div className={`absolute z-10 scale-0 group-hover:scale-100 duration-200 ease-in-out h-44 w-44 top-0 right-0 bg-orange-500`}></div>
            </p>
            <p className={`w-auto group hover:text-white duration-200 ease-in-out rounded-full px-4 py-2 overflow-hidden ${dark ? "text-white" : "text-black"} duration-200 ease-in-out font-Recline text-lg cursor-pointer relative`}>
              <div className={`absolute z-10 scale-0 group-hover:scale-100 duration-200 ease-in-out h-44 w-44 top-0 right-0 bg-orange-500`}></div>
              <span className={`relative z-20`}>Components</span>
            </p>
            <p className={`w-auto group hover:text-white duration-200 ease-in-out rounded-full px-4 py-2 overflow-hidden ${dark ? "text-white" : "text-black"} duration-200 ease-in-out font-Recline text-lg cursor-pointer relative`}>
              <div className={`absolute z-10 scale-0 group-hover:scale-100 duration-200 ease-in-out h-44 w-44 top-0 right-0 bg-orange-500`}></div>
              <span className={`relative z-20`}>How to use</span>
            </p>
            <span onClick={() => { setDark(!dark); }} className={`${dark ? "text-white" : "text-black"} duration-200 ease-in-out cursor-pointer text-xl p-2 rounded-full border`}>{dark ? <CiSun /> : <IoMoonOutline />}</span>
          </div>
        </div>
        ...
        {/* hero section */}
        <div className={`w-full px-5 h-auto mt-32 md:mt-36 flex flex-col justify-start items-center`}>
          <h1 className={`w-full text-6xl md:text-7xl lg:text-8xl xl:text-[110px] text-center font-bold ${dark ? "bg-linear-to-b from-white via-gray-500 to-zinc-800 bg-clip-text text-transparent" : "bg-linear-to-b from-black via-zinc-700 to-zinc-200 bg-clip-text text-transparent"} duration-200 ease-in-out`}>Build Websites 10x Faster</h1>
          <p className={`w-full z-10 text-center ${dark ? "text-white" : "text-black"} px-10 md:px-20 lg:px-28 duration-200 ease-in-out font-semibold mt-5 text-[12px] md:text-lg opacity-60 italic lg:text-xl`}>A react based component UI library powered with TailwindCSS, Motion (formerly Framer Motion)</p>
          <p className={`w-auto px-5 py-2 rounded-full bg-linear-to-br from-orange-400 to-orange-600 mt-7 active:opacity-75 duration-150 ease-in-out text-sm cursor-pointer font-Recline text-white`}>Get Started</p>
          ...
          <div className={`w-full mt-5 flex justify-center items-center gap-4`}>
            <div className={`flex justify-center items-center gap-2`}>
                ...
                <p className={`hidden md:block ${dark ? "text-white" : "text-black"} duration-200 ease-in-out opacity-55 text-[12px]`}>TailwindCSS</p>
            </div>
            <div className={`flex justify-center items-center gap-2`}>
                <span className={`text-xl ${dark ? "text-white" : "text-black"} duration-200 ease-in-out opacity-55`}><RiNextjsFill/></span>
                <p className={`hidden md:block ${dark ? "text-white" : "text-black"} duration-200 ease-in-out opacity-55 text-[12px]`}>NextJs</p>
            </div>
            <div className={`flex justify-center items-center gap-2`}>
                <span className={`text-xl ${dark ? "text-white" : "text-black"} duration-200 ease-in-out opacity-55`}><FaReact/></span>
                <p className={`hidden md:block ${dark ? "text-white" : "text-black"} duration-200 ease-in-out opacity-55 text-[12px]`}>ReactJs</p>
            </div>
          </div>
        </div>

        {/* main section */}
        <div className={`w-full lg:w-[80%] mt-5 columns-2 md:columns-3 h-auto gap-5 py-5 px-5`}>
          ...
          <div className={`w-auto break-inside-avoid mb-4 px-5 py-4 flex flex-col justify-center items-center rounded-lg border ${dark ? "border-gray-500" : "border-zinc-700"} ${dark ? "bg-black hover:bg-linear-to-br from-black via-zinc-900 to-zinc-700" : "bg-white hover:bg-linear-to-br from-white via-gray-100 to-gray-200"} cursor-default duration-200 ease-in-out`}>
            <h1 className={`w-full mb-2 ${dark ? "text-white" : "text-black"} duration-200 ease-in-out text-start font-bold text-xl`}>Templates</h1>
            <p className={`${dark ? "text-white" : "text-black"} duration-200 ease-in-out w-full text-start text-[12px]`}>● Landing Pages</p>
          </div>
