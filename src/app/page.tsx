    ...
    <>
      <div className={`w-full ${dark ? "bg-black" : "bg-white"} min-h-screen flex flex-col justify-start items-center relative overflow-hidden`}>
        ...
        <div className={`w-full px-5 h-auto mt-32 md:mt-36 flex flex-col justify-start items-center`}>
          ...
          <Link href='/components' className={`w-auto px-5 py-2 rounded-full bg-linear-to-br from-orange-400 to-orange-600 mt-7 active:opacity-75 duration-150 ease-in-out text-sm cursor-pointer font-Recline text-white`}>Get Started</Link>
